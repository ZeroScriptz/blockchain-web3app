...
const Services = () => {
    return (
        <div className='flex-col md:flex-row flex w-full justify-center items-center gradient-bg-services'>
            ...
            <div className='flex-1 flex flex-col justify-start items-center'>
                ...
                subtitle="Best exchange rates, we strive for greatness. Providing quality with low fees!"    
                />}
